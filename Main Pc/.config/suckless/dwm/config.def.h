...
"feh", "--no-fehbg", "--bg-fill", "/home/jy/Pictures/wallpapers/oleg.jpg", NULL,
"picom", NULL,
"slstatus", NULL,
NULL /* terminate */
};
...
static const char *mpdvu[]    = { "mpc", "volume", "+1", NULL                };
static const char *mpdvd[]    = { "mpc", "volume", "-1", NULL                };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_Prior,              	  spawn,          {.v = nxttrk   } },
	{ MODKEY,                       XK_Next,                  spawn,          {.v = prvtrk   } },
        { MODKEY,                       XF86XK_AudioRaiseVolume,  spawn,          {.v = mpdvu  } },
	{ MODKEY,                       XF86XK_AudioLowerVolume,  spawn,          {.v = mpdvd    } },
